...
out={}
for data in weather:
    dist_name=data["district"]      #district name and current temp edukkan from main dict
    cur_temp=data["temp"]
    ...
    if dist_name in out:
        ...
        out[dist_name]=cur_temp     #illenkil set key as dist name and temp as cur_temp
            #key        value
print(out)